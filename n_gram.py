class N_gram:
    ...
    def count_words(self):
        ...
        return collections.Counter(self.text_list)
        ### END YOUR CODE HERE ###
    ...
    def calc_word_probs(self):
        ...
        """
        ### START YOUR CODE HERE ###
        return self.normalize_dict(self.count_words())
        ### END YOUR CODE HERE ###
    ...
    def probs_to_neg_log_probs(self, probs_dict):
        ...
        ### START YOUR CODE HERE ###
        neg_log_probs = {}
        for word, probability in probs_dict.items():
          neg_log_probs[word] = -np.log(probability)
        ### END YOUR CODE HERE ###
    ...
    def p_naive(self, curr_word, prev_phrase, n):
        ...
        try:
            ...
            for word_tuple, probability in filtered_adj_counter.items():
              if word_tuple[-1] == curr_word:
                prob = probability
            ### END YOUR CODE HERE ###
        except KeyError:
    ...
    def calc_prob_of_sentence(self, sentence_list, n, p_func=p_laplace):
        ...
        """
        ### START YOUR CODE HERE ###
        return np.exp(-self.calc_neg_log_prob_of_sentence(sentence_list, n))
        ### END YOUR CODE HERE ###
